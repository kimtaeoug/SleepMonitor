...
class OnBoardingScanFragment :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvDescription.text = getString(R.string.onboarding_vital_scan_text)
    ...
    private fun scanDevice() {
        ...
        val scanFilter = ScanFilter.Builder()
            .setServiceUuid(ParcelUuid.fromString(Constant.RX_SERVICE_UUID_TEXT))
            .build()
    ...
    private fun selectComplete(bluetoothDevice: BluetoothDevice) {
        findListener<OnBoardingListener>()?.onSleepDeviceSelected(bluetoothDevice)
    }
    ...
    companion object : FragmentTemplate<OnBoardingScanFragment>()
}
